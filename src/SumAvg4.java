...
public class SumAvg4 {
    public static void main(String[] args) {
        ...
        // Count occurrences of userValue1 in dataPoints
        int count = 0;
        ...
        // Scan for the minimum and maximum values in the dataPoints array
    ...
    // Implement a method to safely get an integer input within a range
